...
namespace Kamgam.UVEditor
{
    public partial class UVEditorWindow : EditorWindow
    {
        ...
        [System.NonSerialized] protected bool _selectionRectDrag;
        ...
        private void OnMouseMove(MouseMoveEvent evt)
        {
            ...
            {
                if (_selectionRectDrag && !anyHandle() && evt.IsLeftPressed())
                {
                    _selectionRectEnd = _uvMousePos;
                }
                else if (!_selectionRectDrag && !anyHandle())
                {
